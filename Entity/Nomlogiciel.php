 ...
 * Nomlogiciel
 *
 * @ORM\Table(name="NomLogiciel", uniqueConstraints={@ORM\UniqueConstraint(name="LaSeule", columns={"Nom", "Version", "IdSyllabusModule"})}, indexes={@ORM\Index(name="IdSyllabusModule", columns={"IdSyllabusModule"})})
 * @ORM\Entity
 */
class Nomlogiciel
{
