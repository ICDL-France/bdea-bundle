...
/**
 * FormationstagiaireBak
 *
 * @ORM\Table(name="FormationStagiaire_bak", uniqueConstraints={@ORM\UniqueConstraint(name="Stagiaire", columns={"IdPersonne", "IdFormation"})}, indexes={@ORM\Index(name="Confirme", columns={"Confirme"})})
 * @ORM\Entity
 */
class FormationstagiaireBak
{
    /**
     * @var integer
     *
