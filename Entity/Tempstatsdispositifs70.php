...
/**
 * Tempstatsdispositifs70
 *
 * @ORM\Table(name="TempStatsDispositifs70")
 * @ORM\Entity
 */
class Tempstatsdispositifs70
{
    /**
     * @var integer
     *
     * @ORM\Column(name="IdTempStatsDispositifs70", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $idtempstatsdispositifs70;
