 ...
 * AdressesBck
 *
 * @ORM\Table(name="Adresses_bck", indexes={@ORM\Index(name="IdDepartement", columns={"IdDepartement"}), @ORM\Index(name="Denomination", columns={"Denomination"}), @ORM\Index(name="IdPays", columns={"IdPays"})})
 * @ORM\Entity
 */
class AdressesBck
{
