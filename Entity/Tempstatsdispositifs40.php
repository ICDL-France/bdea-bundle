...
/**
 * Tempstatsdispositifs40
 *
 * @ORM\Table(name="TempStatsDispositifs40")
 * @ORM\Entity
 */
class Tempstatsdispositifs40
{
    /**
     * @var integer
     *
     * @ORM\Column(name="IdTempStatsDispositifs40", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $idtempstatsdispositifs40;
