 ...
 * Cartes
 *
 * @ORM\Table(name="Cartes", uniqueConstraints={@ORM\UniqueConstraint(name="NumCarte", columns={"NumCarte"})}, indexes={@ORM\Index(name="IdLotsCartes", columns={"IdLotsCartes"}), @ORM\Index(name="IdTypeCarte", columns={"IdTypeCarte"}), @ORM\Index(name="IdFont", columns={"IdFont"}), @ORM\Index(name="IdProspect", columns={"IdProspect"}), @ORM\Index(name="IdClientGestionnaire", columns={"IdClientGestionnaire"}), @ORM\Index(name="IdPersonneDemandeurDuplicata", columns={"IdPersonneDemandeurDuplicata"}), @ORM\Index(name="recherche", columns={"NumCarte", "Prenom", "Nom"})})
 * @ORM\Entity
 */
class Cartes
{
