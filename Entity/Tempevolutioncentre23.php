...
/**
 * Tempevolutioncentre23
 *
 * @ORM\Table(name="TempEvolutionCentre23")
 * @ORM\Entity
 */
class Tempevolutioncentre23
{
    /**
     * @var integer
     *
     * @ORM\Column(name="IdTempEvolutionCentre23", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $idtempevolutioncentre23;
