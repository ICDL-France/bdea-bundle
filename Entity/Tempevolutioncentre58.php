...
/**
 * Tempevolutioncentre58
 *
 * @ORM\Table(name="TempEvolutionCentre58")
 * @ORM\Entity
 */
class Tempevolutioncentre58
{
    /**
     * @var integer
     *
     * @ORM\Column(name="IdTempEvolutionCentre58", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $idtempevolutioncentre58;
