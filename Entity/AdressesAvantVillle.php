 ...
 * AdressesAvantVillle
 *
 * @ORM\Table(name="Adresses_Avant_villle", indexes={@ORM\Index(name="IdDepartement", columns={"IdDepartement"}), @ORM\Index(name="Denomination", columns={"Denomination"}), @ORM\Index(name="IdPays", columns={"IdPays"})})
 * @ORM\Entity
 */
class AdressesAvantVillle
{
    /**
     * @var integer
     *
