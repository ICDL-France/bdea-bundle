...
class Personnes
{
     ...
     * @var string
     *
     * @ORM\Column(name="Clef_prive", type="string", length=10, nullable=false)
     */
    private $clefPrive;
     ...
     * @var boolean
     *
     * @ORM\Column(name="ConsentementRGPD", type="boolean", nullable=false)
     */
    private $consentementrgpd;
     ...
     * @var string
     *
     * @ORM\Column(name="LienMailingRgpd", type="string", length=250, nullable=true)
     */
    private $lienmailingrgpd;
