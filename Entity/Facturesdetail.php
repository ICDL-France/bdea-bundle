 ...
 * Facturesdetail
 *
 * @ORM\Table(name="FacturesDetail", indexes={@ORM\Index(name="IdFactures", columns={"IdFactures"}), @ORM\Index(name="IdArticle", columns={"IdArticle"}), @ORM\Index(name="IdTVA", columns={"IdTVA"}), @ORM\Index(name="IdDetailAvoir", columns={"IdDetailAvoir"})})
 * @ORM\Entity
 */
