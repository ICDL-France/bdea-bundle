...
/**
 * Tempstatsdispositifs62
 *
 * @ORM\Table(name="TempStatsDispositifs62")
 * @ORM\Entity
 */
class Tempstatsdispositifs62
{
    /**
     * @var integer
     *
     * @ORM\Column(name="IdTempStatsDispositifs62", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $idtempstatsdispositifs62;
