 ...
 * Royaltieslivres
 *
 * @ORM\Table(name="RoyaltiesLivres", uniqueConstraints={@ORM\UniqueConstraint(name="PeriodeDebut", columns={"PeriodeDebut"}), @ORM\UniqueConstraint(name="PeriodeFin", columns={"PeriodeFin"})})
 * @ORM\Entity
 */
class Royaltieslivres
{
    /**
     * @var integer
     *
     ...
     * @var integer
     *
     * @ORM\Column(name="NbLivres", type="integer", nullable=true)
     */
    private $nblivres;
