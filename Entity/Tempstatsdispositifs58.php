...
/**
 * Tempstatsdispositifs58
 *
 * @ORM\Table(name="TempStatsDispositifs58")
 * @ORM\Entity
 */
class Tempstatsdispositifs58
{
    /**
     * @var integer
     *
     * @ORM\Column(name="IdTempStatsDispositifs58", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $idtempstatsdispositifs58;
